...
#%% HTML DOC generation
Featlink='/home/nagnanamus/Documents/Final_directory_Stock_Plots_Feb272015/Plots/ALLFeatures/'   
AllPlotslink='/home/nagnanamus/Documents/Final_directory_Stock_Plots_Feb272015/Plots/LinearTrendChannels'

from os import listdir
from os.path import isfile, join

onlyfiles = [ f for f in listdir(Featlink) if isfile(join(Featlink,f)) ] 
MASTERFEATURE=pd.HDFStore('/home/nagnanamus/Documents/Final_directory_Stock_Plots_Feb272015/Plots/MASTERFEATURE.h5')


#i=0
#for f in onlyfiles:
#    AllFeat=pd.HDFStore(Featlink+f)
#    ss=AllFeat['Features'].Symbol.unique()[0]
#    MASTERFEATURE[ss]=AllFeat['Features']
#    AllFeat.close()
#    i=i+1    
#    print i
...
MASTERFEATURE=pd.HDFStore('/home/nagnanamus/Documents/Final_directory_Stock_Plots_Feb272015/Plots/MASTERFEATURE.h5')
MASTERFEATUREkeys=MASTERFEATURE.keys()
#MASTERFEATUREkeys=[ss[1:] for ss in MASTERFEATUREkeys]
MASTERFEATUREkeys=sort(MASTERFEATUREkeys)
ddg=reload(ddg)

ddg.GenerateHTMLDOC_PlotsTable_type2('/home/nagnanamus/Documents/Final_directory_Stock_Plots_Feb272015/Plots/HTMLfiles/',MASTERFEATURE,featkeys=MASTERFEATUREkeys)
ddg.GenerateHTMLDOC_Plots_SideBySide('/home/nagnanamus/Documents/Final_directory_Stock_Plots_Feb272015/Plots/HTMLfiles/',MASTERFEATURE,featkeys=MASTERFEATUREkeys)
ddg.GenerateHTMLDOC_PlotsTableForms2Google_type1('/home/nagnanamus/Documents/Final_directory_Stock_Plots_Feb272015/Plots/HTMLfiles/',MASTERFEATURE,featkeys=MASTERFEATUREkeys,ProductForm='www')
